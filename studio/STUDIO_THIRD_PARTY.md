...
450 Rust crates are compiled into the app (315 in every build; the rest only with the optional denoiser, only on the platform the Build column names, or only in the browser build).
...
https://github.com/logolabs/inkvec/issues or write to office@incorpo.ro, and it will be
removed from the showcases and the benchmark data.
...
| `console_error_panic_hook` | Apache-2.0/MIT | browser |
...
| `js-sys` | MIT OR Apache-2.0 | browser |
...
| `rustversion` | MIT OR Apache-2.0 | browser |
...
| `wasm-bindgen` | MIT OR Apache-2.0 | browser |
| `wasm-bindgen-macro` | MIT OR Apache-2.0 | browser |
| `wasm-bindgen-macro-support` | MIT OR Apache-2.0 | browser |
| `wasm-bindgen-rayon` | Apache-2.0 | browser, threads |
| `wasm-bindgen-shared` | MIT OR Apache-2.0 | browser |
| `wasm_sync` | MIT OR Apache-2.0 | browser, threads |
...
| `web-sys` | MIT OR Apache-2.0 | browser, threads |
| `web-time` | MIT OR Apache-2.0 | browser |
...
| --- | --- | --- | --- |
| ONNX Runtime Web (`onnxruntime-web`) | 1.30.0 | MIT | https://cdn.jsdelivr.net/npm/onnxruntime-web@1.30.0/ |
