...
Generated by `tools/third_party.py` on 2026-09-15. Regenerate it after changing dependencies.
Inkvec itself is licensed under Apache-2.0 (`LICENSE`).

464 Rust crates are compiled across all builds: 80 in every build, 51 more with the ONNX Runtime restorer, 333 more only with other optional features.
...
| bytes | 1.12.1 | MIT | restore-model |
...
| equivalent | 1.0.2 | Apache-2.0 OR MIT | all features |
| errno | 0.3.14 | MIT OR Apache-2.0 | restore-model |
...
| hashbrown | 0.17.1 | MIT OR Apache-2.0 | all features |
...
| http | 1.5.0 | MIT OR Apache-2.0 | restore-model |
| httparse | 1.10.1 | MIT OR Apache-2.0 | restore-model |
...
| indexmap | 2.14.1 | Apache-2.0 OR MIT | all features |
...
| itoa | 1.0.18 | MIT OR Apache-2.0 | restore-model |
...
| lazy_static | 1.5.0 | MIT OR Apache-2.0 | all features |
| libc | 0.2.189 | MIT OR Apache-2.0 | restore-model |
...
| nu-ansi-term | 0.50.3 | MIT | all features |
...
| percent-encoding | 2.3.2 | MIT OR Apache-2.0 | restore-model |
...
| regex-automata | 0.4.18 | MIT OR Apache-2.0 | all features |
| regex-syntax | 0.8.11 | MIT OR Apache-2.0 | all features |
...
| scopeguard | 1.2.0 | MIT OR Apache-2.0 | all features |
...
| serde | 1.0.229 | MIT OR Apache-2.0 | all features |
| serde_bytes | 0.11.19 | MIT OR Apache-2.0 | all features |
| serde_core | 1.0.229 | MIT OR Apache-2.0 | all features |
| serde_derive | 1.0.229 | MIT OR Apache-2.0 | all features |
| serde_json | 1.0.151 | MIT OR Apache-2.0 | all features |
| serde_spanned | 1.1.1 | MIT OR Apache-2.0 | all features |
| sharded-slab | 0.1.7 | MIT | all features |
...
| thread_local | 1.1.10 | MIT OR Apache-2.0 | all features |
...
| tracing | 0.1.44 | MIT | all features |
| tracing-attributes | 0.1.31 | MIT | all features |
| tracing-core | 0.1.36 | MIT | all features |
| tracing-log | 0.2.0 | MIT | all features |
| tracing-subscriber | 0.3.23 | MIT | all features |
...
| version_check | 0.9.5 | MIT/Apache-2.0 | all features |
| void | 1.0.2 | MIT | all features |
| walkdir | 2.5.0 | Unlicense/MIT | all features |
| wasi | 0.11.1+wasi-snapshot-preview1 | Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT | all features |
...
| windows-link | 0.2.1 | MIT OR Apache-2.0 | restore-model |
...
| windows-sys | 0.61.2 | MIT OR Apache-2.0 | restore-model |
