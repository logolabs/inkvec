...
export const prepare: (a: number, b: number, c: number, d: number) => [number, number, number];
export const structure_json: (a: number, b: number) => [number, number];
export const threads_available: () => number;
export const trace: (a: number, b: number, c: number, d: number) => [number, number, number, number];
